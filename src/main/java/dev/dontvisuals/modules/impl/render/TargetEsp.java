...
import dev.dontvisuals.client.util.async.Async;
...
import dev.dontvisuals.client.render.renderers.JelloRenderer;
import dev.dontvisuals.client.render.renderers.SoulRenderer;
...
public class TargetEsp extends Module implements ThemeManager.ThemeChangeListener {
    ...
    private void renderMarkerMain(EventRender2D e, Vec3d centerWorld, float animVal, int colorRGBA) {
        ...
        Render2D.drawTexture(
                ...
                0f,
                dontvisuals.id(modeMarkerNew.getValue() ? "hud/alt_marker.png" : "hud/marker.png"),
                finalColor
        );
