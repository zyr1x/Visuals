...
import dev.dontvisuals.mixin.accessors.IWorldRenderer;
...
public class DamageParticles extends Module implements ThemeManager.ThemeChangeListener {
    ...
    private static final Identifier STAR    = dontvisuals.id("hud/star.png");
    private static final Identifier HEART   = dontvisuals.id("hud/heart.png");
    private static final Identifier DOLLAR  = dontvisuals.id("hud/dollar.png");
    private static final Identifier CIRCLE  = dontvisuals.id("hud/circle.png");
    private static final Identifier AMONGUS = dontvisuals.id("hud/amongus.png");
