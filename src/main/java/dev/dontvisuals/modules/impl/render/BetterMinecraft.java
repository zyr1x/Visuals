...
public class BetterMinecraft extends Module {
	...
	public final BooleanSetting smoothChat = new BooleanSetting("setting.smoothChat", true);
	...
	@Getter private final Animation chatAnimation = new Animation(200, 1.0, false, Easing.BOTH_SINE);
