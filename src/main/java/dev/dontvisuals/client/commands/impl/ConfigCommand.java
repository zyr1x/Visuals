...
import dev.dontvisuals.client.managers.ConfigManager;
...
public class ConfigCommand extends Command {
    ...
    private void saveConfig(String configName) {
        ...
        ConfigManager configManager = dontvisuals.getInstance().getConfigManager();
    ...
    private void suggestConfigs(SuggestionsBuilder suggestionsBuilder) {
        String[] configs = dontvisuals.getInstance().getConfigManager().getConfigList();
