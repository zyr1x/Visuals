package dev.dontvisuals.client.render.msdf;
...
import dev.dontvisuals.client.render.msdf.FontData.AtlasData;
import dev.dontvisuals.client.render.msdf.FontData.GlyphData;
import dev.dontvisuals.client.render.msdf.FontData.MetricsData;
import dev.dontvisuals.client.render.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = dontvisuals.id("fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = dontvisuals.id("fonts/" + atlasFileName + ".png");
			return this;
		}

		public MsdfFont build() {
			dev.dontvisuals.client.render.msdf.FontData data = ResourceProvider.fromJsonToInstance(this.dataIdentifer, FontData.class);
