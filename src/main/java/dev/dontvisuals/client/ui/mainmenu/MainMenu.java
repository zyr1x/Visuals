package dev.dontvisuals.client.ui.mainmenu;

import com.mojang.blaze3d.systems.RenderSystem;
import dev.dontvisuals.client.render.builders.impl.BlurBuilder;
import dev.dontvisuals.client.render.builders.impl.RectangleBuilder;
import dev.dontvisuals.client.render.builders.impl.TextBuilder;
import dev.dontvisuals.client.render.builders.states.QuadColorState;
import dev.dontvisuals.client.render.builders.states.QuadRadiusState;
import dev.dontvisuals.client.render.builders.states.SizeState;
...
public class MainMenu extends Screen {
    ...
    public MainMenu() {
        super(Text.literal(I18n.translate("dontvisuals.mainmenu.screen_title")));
    ...
    protected void init() {
        ...
        // Add buttons
        buttons.add(new AnimatedButton(centerX, centerY - buttonHeight * 2f - margin * 2, buttonWidth, buttonHeight, I18n.translate("dontvisuals.mainmenu.singleplayer"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new SelectWorldScreen(this), this))));

        buttons.add(new AnimatedButton(centerX, centerY - buttonHeight - margin, buttonWidth, buttonHeight, I18n.translate("dontvisuals.mainmenu.multiplayer"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new MultiplayerScreen(this), this))));

        buttons.add(new AnimatedButton(centerX, centerY, buttonWidth, buttonHeight, I18n.translate("dontvisuals.mainmenu.options"),
        ...
        buttons.add(new AnimatedButton(centerX, centerY + buttonHeight + margin, halfWidth, buttonHeight, I18n.translate("dontvisuals.mainmenu.altmanager"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new AltManagerScreen(this), this))));
        buttons.add(new AnimatedButton(centerX + halfWidth + margin, centerY + buttonHeight + margin, halfWidth, buttonHeight, I18n.translate("dontvisuals.mainmenu.quit"),
        ...
        if (!welcomePlayed) {
            ...
            MinecraftClient.getInstance().getSoundManager().play(
                    PositionedSoundInstance.master(
                            SoundEvent.of(Identifier.of("dontvisuals:welcome")),
                            1.0f,
                            1.0f
                    )
            );
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float delta) {
        ...
        // Заголовок
        String title = I18n.translate("dontvisuals.mainmenu.title");
        ...
        // Копирайт
        String copyright = I18n.translate("dontvisuals.mainmenu.copyright");
