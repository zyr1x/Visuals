...
import dev.dontvisuals.client.events.impl.EventKey;
...
import dev.dontvisuals.modules.impl.render.*;
import dev.dontvisuals.modules.impl.utility.*;
        ...
        for (Module module : modules) {
            ...
            switch (e.getAction()) {
                case GLFW.GLFW_PRESS -> {
                    if (module.getBind().getMode() == dev.dontvisuals.modules.settings.api.Bind.Mode.HOLD) module.setToggled(true);
                    else module.toggle();
                }
                case GLFW.GLFW_RELEASE -> {
                    if (module.getBind().getMode() == dev.dontvisuals.modules.settings.api.Bind.Mode.HOLD) module.setToggled(false);
                }
            }
        }
    }
